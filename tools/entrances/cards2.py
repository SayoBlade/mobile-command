...
N = [
    ...
    dict(key="jenkins", t="t-jenkins", name='The Jenkin family', sub='Caretakers of the Druskenvald Estate', map="map-crooked",
         art='<span><img src="art/dani.webp" alt=""></span><span><img src="art/gilly.webp" alt=""></span><span><img src="art/walter.webp" alt=""></span>', label='the Jenkin family', where='the Druskenvald Estate',
         pair=True,
    ...
    dict(key="boogle", t="t-boogle", name="The Boogleswarm", sub="", map="map-crooked",
         art=shaded("boogleswarm"), label="the Boogleswarm", where="the Crooked House",
                  extra='<img class="sprite scurry" src="art/weasel.webp" alt="">',
         eyebrow="Chapter 12 \u00b7 the Crooked House",
         artline="The module's monster plate, over the Crooked House map. The running weasel is one of the book's margin drawings.",
         moves="It pours out of a black silhouette while a weasel runs the length of the banner."),
    dict(key="wisp", t="t-wisp", name="Wisp", sub="There's something off about that cat", map="map-crooked",
         art=shaded("ketgrin"), label="Wisp", where="the Crooked House",
         eyebrow="Chapter 12 \u00b7 the Crooked House",
         artline="The Ketgrin's plate from the module \u2014 a grey cat wearing far too many eyes \u2014 over the house map.",
         moves="He comes out of a black silhouette, the way you notice the eyes one at a time."),
    dict(key="lurker", t="t-lurker", name="The Lurker in the Dark", sub="", map="map-crooked",
         art=shaded("lurker"), front='<div class="flash"></div>',
         label="the Lurker in the Dark", where="the Crooked House",
         eyebrow="Chapter 12 \u00b7 the Crooked House",
         artline="Its plate from the module, over the house map.",
         moves="A lightning flash shows it \u2014 the Crooked Man's bolt, and his white flash on the token \u2014 with no rain: it is already indoors."),
    dict(key="monweasel", t="t-monweasel", name="A Monstrous Weasel", sub="", map="map-crooked",
         art=shaded("vweasel"), label="the weasel", where="the Crooked House",
         extra='<img class="sprite scurry" src="art/weasel.webp" alt="">',
         eyebrow="Chapter 12 \u00b7 the Crooked House",
         artline="The Vermin Familiar plate from the module. Deliberately unnamed: the table meets a big weasel, not a hag's familiar.",
         moves="It is revealed from a silhouette while a weasel runs the length of the banner."),
    dict(key="toys", t="t-toys", name="The Playthings", sub="Three toys, and none of them are still",
         map="map-crooked", pair=True, dur=8200,
         art='<span><img src="art/raven.webp" alt=""></span><span><img src="art/goat.webp" alt=""></span><span><img src="art/bunny.webp" alt=""></span>',
         label="the nursery toys", where="the Crooked House nursery",
         eyebrow="Chapter 12 · the Crooked House",
         artline="Not the module's art — three pictures the DM generated in its style and cleaned to transparency, "
                 "which are also the tokens (mc-portraits/nursery).",
         moves="They arrive one at a time, raven then goat then bunny, each with its own voice and its token appearing "
               "on the map. The window goes white at the end and all three tokens flash with it."),
