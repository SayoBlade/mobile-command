...
(async () => {
  ...
  const PLAN = [{"a": "A80", "label": "Porch bolt", "img": "icons/magic/lightning/bolt-strike-blue.webp", "page": 1, "scenes": ["12.1"], "note": "Lightning beside the porch, and its thunder a second or two later.", "command": "// Deck Command action key A80 — Lightning beside the porch, and its thunder a second or two later.\n// Generated by mobile-command/tools/gen-house-keys.py. Every verb lives in deck-command's action\n// runtime, so this macro is a script of calls and never a mechanism of its own.\nconst act = game.modules.get(\"deck-command\")?.api?.act;\nif (!act) return ui.notifications.warn(\"Deck Command is not active, so this key has nothing to call.\");\n(async () => {\n  await act.fx({\"id\": \"lightning\"});\n})();", "takes": []}, {"a": "A81", "label": "Front door", "img": "icons/svg/door-open-outline.svg", "page": 1, "scenes": ["12.1"], "note": "The front door swings open on its own.", "command": "// Deck Command action key A81 — The front door swings open on its own.\n// Generated by mobile-command/tools/gen-house-keys.py. Every verb lives in deck-command's action\n// runtime, so this macro is a script of calls and never a mechanism of its own.\nconst act = game.modules.get(\"deck-command\")?.api?.act;\nif (!act) return ui.notifications.warn(\"Deck Command is not active, so this key has nothing to call.\");\n(async () => {\n  await act.door({\"cm\": \"door:front\", \"state\": \"open\"});\n})();", "takes": [{"board": "12.1", "page": 1, "box": 1, "label": "Door Creaks"}]}, {"a": "A83", "label": "Hearth lit", "img": "icons/magic/fire/flame-burning-campfire-orange.webp", "page": 1, "scenes": ["12.1"], "note": "A pleasant fire catches in the parlour as the seance begins.", "command": "// Deck Command action key A83 — A pleasant fire catches in the parlour as the seance begins.\n// Generated by mobile-command/tools/gen-house-keys.py. Every verb lives in deck-command's action\n// runtime, so this macro is a script of calls and never a mechanism of its own.\nconst act = game.modules.get(\"deck-command\")?.api?.act;\nif (!act) return ui.notifications.warn(\"Deck Command is not active, so this key has nothing to call.\");\n(async () => {\n  await act.light({\"cm\": \"light:hearth\", \"on\": true});\n  await act.loop({\"cm\": \"12.1:sound:3\", \"on\": true});\n})();", "takes": []}, {"a": "A84", "label": "Hearth out", "img": "icons/magic/unholy/orb-smoking-green.webp", "page": 1, "scenes": ["12.1"], "note": "The fire dies, the loop stops, and darkness falls on the parlour.", "command": "// Deck Command action key A84 — The fire dies, the loop stops, and darkness falls on the parlour.\n// Generated by mobile-command/tools/gen-house-keys.py. Every verb lives in deck-command's action\n// runtime, so this macro is a script of calls and never a mechanism of its own.\nconst act = game.modules.get(\"deck-command\")?.api?.act;\nif (!act) return ui.notifications.warn(\"Deck Command is not active, so this key has nothing to call.\");\n(async () => {\n  await act.light({\"cm\": \"light:hearth\", \"on\": false});\n  await act.loop({\"cm\": \"12.1:sound:3\", \"on\": false});\n})();", "takes": [{"board": "12.1", "page": 2, "box": 1, "label": "Fire Dies"}, {"board": "12.1", "page": 2, "box": 2, "label": "Silence Falls"}, {"board": "12.1", "page": 2, "box": 3, "label": "Last Words"}]}, {"a": "A89", "label": "Waltz", "img": "icons/tools/instruments/harp-lap-brown.webp", "page": 1, "scenes": ["12.1"], "note": "The harpsichord's waltz, heard across the whole first floor.", "command": "// Deck Command action key A89 — The harpsichord's waltz, heard across the whole first floor.\n// Generated by mobile-command/tools/gen-house-keys.py. Every verb lives in deck-command's action\n// runtime, so this macro is a script of calls and never a mechanism of its own.\nconst act = game.modules.get(\"deck-command\")?.api?.act;\nif (!act) return ui.notifications.warn(\"Deck Command is not active, so this key has nothing to call.\");\n(async () => {\n  await act.loop({\"cm\": \"12.1:sound:1\", \"on\": true});\n})();", "takes": []}, {"a": "A90", "label": "Waltz off", "img": "icons/svg/sound-off.svg", "page": 1, "scenes": ["12.1"], "note": "The waltz stops on the Performance success.", "command": "// Deck Command action key A90 — The waltz stops on the Performance success.\n// Generated by mobile-command/tools/gen-house-keys.py. Every verb lives in deck-command's action\n// runtime, so this macro is a script of calls and never a mechanism of its own.\nconst act = game.modules.get(\"deck-command\")?.api?.act;\nif (!act) return ui.notifications.warn(\"Deck Command is not active, so this key has nothing to call.\");\n(async () => {\n  await act.loop({\"cm\": \"12.1:sound:1\", \"on\": false});\n})();", "takes": [{"board": "12.1", "page": 3, "box": 2, "label": "Music Stops"}]}, {"a": "A93", "label": "Oven bursts", "img": "icons/magic/death/skull-energy-light-purple.webp", "page": 1, "scenes": ["12.1"], "note": "The oven door bursts open in flame and the screaming stops.", "command": "// Deck Command action key A93 — The oven door bursts open in flame and the screaming stops.\n// Generated by mobile-command/tools/gen-house-keys.py. Every verb lives in deck-command's action\n// runtime, so this macro is a script of calls and never a mechanism of its own.\nconst act = game.modules.get(\"deck-command\")?.api?.act;\nif (!act) return ui.notifications.warn(\"Deck Command is not active, so this key has nothing to call.\");\n(async () => {\n  await act.cue({\"cm\": \"room:oven\", \"on\": false});\n  await act.roomSound({\"src\": \"assets/Personal/SFX/Magic Spells Vol 2/Fire/Fireball J.wav\", \"volume\": 0.8, \"at\": {\"x\": 2170, \"y\": 910}, \"radius\": 30});\n})();", "takes": [{"board": "12.1", "page": 3, "box": 6, "label": "Oven Flames"}, {"board": "12.1", "page": 3, "box": 7, "label": "Souls Shriek"}, {"board": "12.1", "page": 3, "box": 8, "label": "Man Screams"}]}, {"a": "A94", "label": "Oven quiet", "img": "icons/svg/sound-off.svg", "page": 1, "scenes": ["12.1"], "note": "The screams behind the oven stop when the glyph is disarmed.", "command": "// Deck Command action key A94 — The screams behind the oven stop when the glyph is disarmed.\n// Generated by mobile-command/tools/gen-house-keys.py. Every verb lives in deck-command's action\n// runtime, so this macro is a script of calls and never a mechanism of its own.\nconst act = game.modules.get(\"deck-command\")?.api?.act;\nif (!act) return ui.notifications.warn(\"Deck Command is not active, so this key has nothing to call.\");\n(async () => {\n  await act.cue({\"cm\": \"room:oven\", \"on\": false});\n})();", "takes": [{"board": "12.1", "page": 3, "box": 9, "label": "Glyph Disarmed"}]}, {"a": "A95", "label": "Petunia go", "img": "icons/magic/death/hand-undead-skeleton-fire-green.webp", "page": 1, "scenes": ["12.1"], "note": "Petunia fades in peace and her bench falls quiet.", "command": "// Deck Command action key A95 — Petunia fades in peace and her bench falls quiet.\n// Generated by mobile-command/tools/gen-house-keys.py. Every verb lives in deck-command's action\n// runtime, so this macro is a script of calls and never a mechanism of its own.\nconst act = game.modules.get(\"deck-command\")?.api?.act;\nif (!act) return ui.notifications.warn(\"Deck Command is not active, so this key has nothing to call.\");\n(async () => {\n  await act.cue({\"cm\": \"room:petunia\", \"on\": false});\n  await act.tokens({\"match\": [\"Petunia\"], \"show\": false});\n})();", "takes": [{"board": "12.1", "page": 4, "box": 1, "label": "Petunia Rests"}, {"board": "12.1", "page": 4, "box": 2, "label": "Soul Fades"}]}, {"a": "A125", "label": "Door slams", "img": "icons/svg/door-open-outline.svg", "page": 2, "scenes": ["12.1", "12.2", "12.3", "12.4"], "note": "The nearest door opens or shuts by itself. A locked one is left alone.", "command": "// Deck Command action key A125 — The nearest door opens or shuts by itself. A locked one is left alone.\n// Generated by mobile-command/tools/gen-house-keys.py. Every verb lives in deck-command's action\n// runtime, so this macro is a script of calls and never a mechanism of its own.\nconst act = game.modules.get(\"deck-command\")?.api?.act;\nif (!act) return ui.notifications.warn(\"Deck Command is not active, so this key has nothing to call.\");\n(async () => {\n  await act.door({\"state\": \"toggle\"});\n})();", "takes": [{"board": "12.1", "page": 5, "box": 10, "label": "Door Slams"}, {"board": "12.2", "page": 3, "box": 10, "label": "Door Slams"}, {"board": "12.3", "page": 4, "box": 10, "label": "Door Slams"}, {"board": "12.4", "page": 3, "box": 10, "label": "Door Slams"}]}, {"a": "A126", "label": "Locks it", "img": "icons/svg/door-locked-outline.svg", "page": 2, "scenes": ["12.1", "12.2", "12.3", "12.4"], "note": "The nearest door locks behind them.", "command": "// Deck Command action key A126 — The nearest door locks behind them.\n// Generated by mobile-command/tools/gen-house-keys.py. Every verb lives in deck-command's action\n// runtime, so this macro is a script of calls and never a mechanism of its own.\nconst act = game.modules.get(\"deck-command\")?.api?.act;\nif (!act) return ui.notifications.warn(\"Deck Command is not active, so this key has nothing to call.\");\n(async () => {\n  await act.door({\"state\": \"locked\"});\n})();", "takes": []}];
